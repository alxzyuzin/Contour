...
namespace ContourHelpersTest
{
	...
	ContourHelpersTest::TestUtils::TestUtils()
	{
	}

//	bool ContourHelpersTest::TestUtils::CompareContours(Contour* contour, Point* points, int expectedPointsNumber, wchar_t *message, int messageLength)
//	{
...
//	bool ContourHelpersTest::TestUtils::CompareLevelData(unsigned char levelData[], unsigned char referenceData[], int dataLength, wchar_t *message, int messageLength)
//	{
